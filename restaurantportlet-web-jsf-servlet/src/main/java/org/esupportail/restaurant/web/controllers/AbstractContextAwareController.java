 ...
 * http://sourcesup.cru.fr/projects/restaurantportlet
 */
...
public abstract class AbstractContextAwareController extends AbstractDomainAwareBean {
	...
	/**
	 * @see org.esupportail.restaurant.web.controllers.AbstractDomainAwareBean#afterPropertiesSetInternal()
	 */
	@Override
	...
	/**
	 * @see org.esupportail.restaurant.web.controllers.AbstractDomainAwareBean#getCurrentUser()
	 */
	@Override
